...
public static class Vcf01ProfileParser
{
    ...
    public static List<FullProfile> ParseVcfFile(string vcfFilePath, string imagesSavePath)
    {
        var vCards = new List<FullProfile>();
